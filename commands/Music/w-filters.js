module.exports = {
    ...
    execute(client, message) {
        ...
        client.filters.forEach((filterName) => {
            ...
            array.push(filterName.charAt(0).toUpperCase() + filterName.slice(1) + " : " + (client.distube.getQueue(message).filters[filterName] ? client.emotes.success : client.emotes.off));
        });
