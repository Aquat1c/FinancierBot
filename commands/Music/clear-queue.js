module.exports = {
    ...
    execute(client, message) {
        ...
        if (client.distube.getQueue(message).tracks.length <= 1) return message.channel.send(`${client.emotes.error} - There is only one song in the queue.`);

        client.distube.clearQueue(message);
